...
if(xml)
  ...
  if(DEFINED LIBXML2_ROOT)
    ...
    #find_path(LIBXML2_INCLUDE_DIR tree.h PATHS ${LIBXML2_ROOT}/include NO_DEFAULT_PATH)
    file(GLOB_RECURSE LIBXML2_INCLUDE_TREE_H ${LIBXML2_ROOT}/include/tree.h)
    set(LIBXML2_LIBRARY_DIR "${LIBXML2_ROOT}/lib")
    find_library(LIBXML2_LIBRARIES xml2 PATHS ${LIBXML2_LIBRARY_DIR} NO_DEFAULT_PATH)
    if(NOT LIBXML2_LIBRARIES OR NOT LIBXML2_INCLUDE_TREE_H)
      message(FATAL_ERROR "Custom LibXml2 not found.")
    endif()
    get_filename_component(LIBXML2_INCLUDE_DIR ${LIBXML2_INCLUDE_TREE_H} DIRECTORY)
    get_filename_component(LIBXML2_INCLUDE_DIR ${LIBXML2_INCLUDE_DIR} DIRECTORY)
    message(STATUS "Custom LibXml2. Include: ${LIBXML2_INCLUDE_DIR} Library: ${LIBXML2_LIBRARIES}")
  else()
...
if(ssl)
  ...
  if(DEFINED OPENSSL_ROOT)
    ...
    find_library(OPENSSL_LIBRARY_SSL ssl PATHS ${OPENSSL_LIBRARY_DIR} NO_DEFAULT_PATH)
    find_library(OPENSSL_LIBRARY_CRYPTO crypto PATHS ${OPENSSL_LIBRARY_DIR} NO_DEFAULT_PATH)
    if(NOT OPENSSL_LIBRARY_SSL OR NOT OPENSSL_LIBRARY_CRYPTO)
      message(FATAL_ERROR "Custom OpenSSL not found.")
    endif()
    set(OPENSSL_LIBRARIES ${OPENSSL_LIBRARY_SSL} ${OPENSSL_LIBRARY_CRYPTO})
    message(STATUS "Custom OpenSSL. Include: ${OPENSSL_INCLUDE_DIR} Library: ${OPENSSL_LIBRARIES}")
  else()
